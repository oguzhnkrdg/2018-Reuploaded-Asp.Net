<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="HastaneOtomasyon.Admin.WebForm1" %>
    ...
    <form id="form2" runat="server">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div>
                    <asp:Repeater ID="rpt_RandevuOzetTbl" runat="server">
                        <HeaderTemplate>
...
<![endif]-->
        ...
        <script type="text/javascript">
            jQuery(function ($) {
                ...
                .attr('title', 'Göster/gizle sütun').tooltip({ container: 'body' });
