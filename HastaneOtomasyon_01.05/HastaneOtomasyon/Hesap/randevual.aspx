<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="randevual.aspx.cs" Inherits="HastaneOtomasyon.Hesap.randevual" %>
                ...
                <div class="col-md-4 col-md-offset-4 ">
                    <div>
                        ...
                        <div class="form-group form-group-lg ">
                            ...
                            <asp:Button ID="btnRegister" Style="text-decoration:none;" CssClass="btn btn-link btn-lg" runat="server" Text="Yenİ Kayıt" PostBackUrl="~/Hesap/yenikayit.aspx" />
                        </div>
                    </div>
                </div>
            </div>
