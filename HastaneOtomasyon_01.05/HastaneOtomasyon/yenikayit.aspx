<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="yenikayit.aspx.cs" Inherits="HastaneOtomasyon.yenikayit" %>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group form-group-lg ">
                            <div class="col-md-offset-3 col-md-7">
                                ...
                                <asp:Button ID="btnSignIn" Style="text-decoration:none;" CssClass="btn btn-link btn-lg" runat="server" Text="Oturum Aç" PostBackUrl="~/randevual.aspx" />
                            </div>
