<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Kaydol.aspx.cs" Inherits="MasterPage_Amp11b.Kaydol" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width: 100%">
        ...
        <tr>
            <td style="width: 212px">Kullanıcı Adı</td>
            <td>
                <asp:TextBox ID="txt_yk_kulad" runat="server" CssClass="fields"></asp:TextBox>

            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Kullanıcı adı boş geçilemez." ForeColor="Red" ControlToValidate="txt_yk_kulad" Display="Dynamic" ValidationGroup="kayit">*</asp:RequiredFieldValidator>&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        </tr>
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Parola boş geçilemez." ForeColor="Red" ControlToValidate="txt_yk_parola" Display="Dynamic" ValidationGroup="kayit">*</asp:RequiredFieldValidator></td>
        </tr>
        <tr>
            <td style="width: 212px">Parola Tekrar</td>
            <td>
                <asp:TextBox ID="txt_yk_parolatekrar" runat="server" CssClass="fields"
                    TextMode="Password"></asp:TextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="Parola tekrarı boş geçilemez." ForeColor="Red" ControlToValidate="txt_yk_parolatekrar" Display="Dynamic" ValidationGroup="kayit">*</asp:RequiredFieldValidator>
                <asp:CompareValidator ControlToValidate="txt_yk_parolatekrar" ID="CompareValidator2"
                    ValidationGroup="kayit" ErrorMessage="Parola ve tekrarı eşleşmedi."
                    runat="server" Display="Dynamic"
                    ForeColor="Red" ControlToCompare="txt_yk_parola">*</asp:CompareValidator>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Ad bilgisi boş geçilemez." ForeColor="Red" ControlToValidate="txt_adi" Display="Dynamic" ValidationGroup="kayit">*</asp:RequiredFieldValidator></td>
        </tr>
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Soyadı bilgisi boş geçilemez." ForeColor="Red" ControlToValidate="txt_soyadi" Display="Dynamic" ValidationGroup="kayit">*</asp:RequiredFieldValidator></td>
        </tr>
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Doğum yeri bilgisini seçiniz." ForeColor="Red" ControlToValidate="drp_dogum_yeri" Display="Dynamic" InitialValue="-1" ValidationGroup="kayit">*</asp:RequiredFieldValidator>
                <asp:CompareValidator ControlToValidate="drp_dogum_yeri" ID="CompareValidator1"
                    ValidationGroup="kayit" ErrorMessage="Lütfen bir il seçiniz."
                    runat="server" Display="Dynamic"
        ...
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Lütfen bir doğum tarihi giriniz." ForeColor="Red" ControlToValidate="txt_dogum_tarihi" Display="Dynamic" ValidationGroup="kayit">*</asp:RequiredFieldValidator></td>
        </tr>
        <tr>
            <td style="width: 212px">&nbsp;</td>
            <td>&nbsp;</td>
        ...
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="Adres bilgisi boş geçilemez." ForeColor="Red" ControlToValidate="txt_adres" Display="Dynamic" ValidationGroup="kayit">*</asp:RequiredFieldValidator></td>
        </tr>
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="Telefon bilgisi boş geçilemez." ForeColor="Red" ControlToValidate="txt_tel" Display="Dynamic" ValidationGroup="kayit">*</asp:RequiredFieldValidator></td>
        </tr>
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="E-Posta bilgisi boş geçilemez." ForeColor="Red" ControlToValidate="txt_eposta" Display="Dynamic" ValidationGroup="kayit">*</asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="@ ve . işaretlerini içeren geçerli bir eposta adresi giriniz. " ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ValidationGroup="kayit" ControlToValidate="txt_eposta">*</asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            <td colspan="2">
        ...
        <tr>
            <td style="width: 212px">
                <asp:ValidationSummary ID="ValidationSummary1" runat="server" ValidationGroup="kayit" ForeColor="Red" />
            </td>
            <td style="vertical-align: top;">
                <asp:Button ID="btn_kaydol" runat="server" CssClass="fields btnrenk"
                    Text="Kaydol" ValidationGroup="kayit" OnClick="btn_kaydol_Click" />
            </td>
            <td>&nbsp;</td>
        </tr>
    </table>
