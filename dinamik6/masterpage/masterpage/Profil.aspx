<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Profil.aspx.cs" Inherits="masterpage.WebForm2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        ...
        <tr>
            ...
            <td class="auto-style4">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txt_p_kulad" Display="Dynamic" ErrorMessage="Kullanıcı adı bilgisi boş geçilemez." ForeColor="Red" ValidationGroup="profil">*</asp:RequiredFieldValidator>
                &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        </tr>
        <tr>
            <td>Parola</td>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txt_p_parola" Display="Dynamic" ErrorMessage="Parola bilgisi boş geçilemez." ForeColor="Red" ValidationGroup="profil">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>Adı</td>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_adi" Display="Dynamic" ErrorMessage="Ad bilgisi boş geçilemez." ForeColor="Red" ValidationGroup="profil">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>Soyadı</td>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txt_soyadi" Display="Dynamic" ErrorMessage="Soyadı bilgisi boş geçilemez." ForeColor="Red" ValidationGroup="profil">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>Doğum Yeri</td>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="drp_dogum_yeri" Display="Dynamic" ErrorMessage="Doğum yeri bilgisini seçiniz." ForeColor="Red" InitialValue="-1" ValidationGroup="profil">*</asp:RequiredFieldValidator>
                <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="drp_dogum_yeri" Display="Dynamic" ErrorMessage="Lütfen bir il seçiniz." ForeColor="Red" Operator="NotEqual" Type="Integer" ValidationGroup="profil" ValueToCompare="-1">*</asp:CompareValidator>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txt_dogum_tarihi" Display="Dynamic" ErrorMessage="Lütfen bir doğum tarihi giriniz." ForeColor="Red" ValidationGroup="profil">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        ...
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txt_adres" Display="Dynamic" ErrorMessage="Adres bilgisi boş geçilemez." ForeColor="Red" ValidationGroup="profil">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txt_tel" Display="Dynamic" ErrorMessage="Telefon bilgisi boş geçilemez." ForeColor="Red" ValidationGroup="profil">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>E-Posta</td>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txt_eposta" Display="Dynamic" ErrorMessage="E-Posta bilgisi boş geçilemez." ForeColor="Red" ValidationGroup="profil">*</asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txt_eposta" ErrorMessage="@ ve . işaretlerini içeren geçerli bir eposta adresi giriniz. " ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ValidationGroup="profil">*</asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            <td colspan="2">
        ...
        <tr>
            <td>
                <asp:ValidationSummary ID="ValidationSummary1" runat="server" ForeColor="Red" ValidationGroup="profil" />
            </td>
            <td>
                <asp:Button ID="btn_guncelle" runat="server" CssClass="fields btnrenk" OnClick="btn_guncelle_Click" Text="Profil Güncelle" ValidationGroup="profil" />
            </td>
            <td>&nbsp;</td>
        </tr>
    </table>
